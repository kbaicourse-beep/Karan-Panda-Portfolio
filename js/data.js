...
const HOME = {
  ...
  featuredProjectIds: ["panda-print", "student-budget", "rath-yatra", "grocery-wallet"],
  ...
  archiveTag: "Blogs",
  archive: [
    { title: "The Loan App That Has To Work Standing Up", tag: "[UX]", image: "images/vitto/VITTO-00-HOMEPAGE-ARCHIVE-TILE.jpg", href: "archive-post.html?id=vitto-loan-app", isNew: true },
...
const ABOUT = {
  ...
  lift: {
    ...
    image: "images/about/ABOUT-02-LIFT-ILLUSTRATION-DIPS.gif",
  },
...
const PROJECTS = [
  {
    ...
    badge: "Case Study",
    comingSoon: true, // disables the link everywhere this card renders (home, work grid, carousel) and shows a "Coming Soon" badge instead — overview text stays visible
...

  {
    ...
    caseStudy: {
      ...
      blocks: [
        ...
        {
          type: "image",
          src: "images/panda-print/PANDA-26-V1-APP-FULL-WALKTHROUGH.gif",
          placeholder: "Full walkthrough — every V1 app screen, in motion, start to finish",
          aspect: "393/852",
          maxWidth: 340,
        },
        ...
        },
        {
          ...
          src: "images/panda-print/PANDA-27-PORTAL-FULL-WALKTHROUGH-VIDEO.mp4",
          aspect: "1900/800",
          maxWidth: 1900,
          label: "Full walkthrough video — every portal screen, in motion, start to finish",
        },
    ...
    caseStudy: {
      ...
      blocks: [
        ...
        { type: "textBlock", body: "Odia is the language of the region, and its letterforms show up in Indian dairy branding far less often than you'd expect. This mark takes the Odia letter ଚ (cha) — the first sound in Chilika — and rebuilds it as a clean, modern ring. The outer circle reads as containment and origin; the inner void reads, depending how long you look at it, as a drop of milk or a bowl of dahi sitting at the centre of the brand." },
        {
          ...
          media: "images/chilika-dairy/CHILIKA-DAIRY-23-CONCEPT-TWO-ANATOMY-DIAGRAM.jpg",
...

  {
    ...
    caseStudy: {
      ...
      blocks: [
        ...
        {
          type: "videoPlaceholder",
          src: "images/masked-murders/MASKED-MURDERS-10-CHARACTER-MOVEMENT-DEVELOPMENT-CAPTURE.mp4",
          aspect: "16/9",
          label: "Character movement, mid-development — the detective sprite's walk cycle being tested against the village tileset before the build was locked.",
        },
  ...
  const ARCHIVE_POSTS = [
  {
    ...
    indexLabel: "[01]",
    tagline: "How an old sari becomes a canvas trusted to stand in for a god.",
    ...
    blocks: [
      { type: "image", src: "images/patachitra/PATACHITRA-21-HERO-FULL-PAINTING-KRISHNA.jpg", placeholder: "Full painting — blue flute-playing Krishna, red background" },
      {
        type: "textBlock",
      ...
      },
      {
        ...
        items: [
          { src: "images/patachitra/PATACHITRA-23-CANVAS-WASHED-GLUED-LAYERS.jpg", title: "Washed & Glued", body: "Old cotton sari, washed and dried, then two layers bound together with Manja Atha — ground tamarind seed gum." },
          { src: "images/patachitra/PATACHITRA-24-CANVAS-SUN-DRIED.jpg", title: "Sun-Dried", body: "Dried flat in direct sun." },
          { src: "images/patachitra/PATACHITRA-25-CANVAS-STONE-POWDER-COATED.jpg", title: "Coated", body: "Stone powder and gum, rubbed on with a cotton puff." },
          { src: "images/patachitra/PATACHITRA-26-CANVAS-SMOOTHED-STEEL-EDGE.jpg", title: "Smoothed", body: "Levelled with a steel edge." },
          { src: "images/patachitra/PATACHITRA-27-CANVAS-BURNISHED-PEBBLE.jpg", title: "Burnished", body: "Polished with pebbles (Pataastra) until glossy and waterproof." },
          { src: "images/patachitra/PATACHITRA-28-CANVAS-CUT-TO-SIZE.jpg", title: "Cut To Size", body: "Set sizes, 6×4 in up to 40×24 in." },
        ],
      },
...

      {
        ...
        image: "images/patachitra/PATACHITRA-22-ARTISAN-PORTRAIT-AT-WORK.jpg",
...

      {
        ...
        items: [
          ...
          { src: "images/patachitra/PATACHITRA-19-DIGITAL-REINTERPRETATION-NAVAGUNJARA-NAR.jpg", placeholder: "Tala Patra style — Navagunjara, engraved on palm leaf", title: "Tala Patra, Engraved", body: "Palm-leaf art, drawn with a pointed iron tool — used to engrave the outline into the leaf itself before filling it in with colour." },
        ],
      },
      ...
      { type: "image", src: "images/patachitra/PATACHITRA-29-ME-PAINTING-ON-PREPARED-CLOTH.jpg", placeholder: "Me, painting on a cloth I prepared myself" },
      {
        type: "cardGrid",
        heading: "A Krishna Painting, Start To Finish",
        cols: 3,
        items: [
          { src: "images/patachitra/PATACHITRA-30-LINE-WORK-SKETCH.jpg", title: "Line Work", body: "Pose sketched first, on a canvas I prepared myself." },
          { src: "images/patachitra/PATACHITRA-31-FILL-COLOUR-IN-PROGRESS.jpg", title: "Fill Colour", body: "Blue and yellow first, block by block. Red comes last." },
          { src: "images/patachitra/PATACHITRA-32-FINAL-PIECE-KRISHNA.jpg", title: "Final Piece", body: "Finished — Krishna, red background, start to end." },
        ],
      },
  ...
  {
    id: "vitto-loan-app",
    title: "The Loan App That Has To Work Standing Up",
    tag: "Design Assessment",
    indexLabel: "[03]",
    isNew: true,
    tagline: "A design assessment for a UI/UX Design Intern role — reasoning made visible, not just polished screens.",
    heroImage: "images/vitto/VITTO-00-COVER.jpg",
    meta: [
      { label: "Role", val: "UI/UX Design Intern — Assessment" },
      { label: "Company", val: "Vitto — Lending Infrastructure" },
      { label: "Platform", val: "Field Agent App, Android" },
      { label: "Status", val: "Submitted — Awaiting Outcome" },
    ],
    blocks: [
      {
        type: "noteBox",
        label: "Why This Is Here",
        text: "This isn't a personal project — it's the actual design assessment I submitted for a UI/UX Design Intern role at Vitto. I'm publishing the full reasoning behind it, including a decision I made and then reversed, because the reasoning is usually the part a case study hides.",
      },

      {
        type: "textBlock",
        lede: true,
        body: "Vitto builds the software banks, NBFCs and microfinance lenders use to run lending end-to-end — they don't lend money themselves. Their field agents, called Sathis, walk into small shops and sign up interested owners for loans right there, on the spot: a grocer, a tailor, a mobile-repair counter. The assignment's own example was Ramesh, a grocery owner interested in a ₹2 lakh loan, interrupted four times by customers over a twenty-minute visit, with the signal dropping entirely at points. The brief was blunt about the current state of things: Sathis do this on a form that was designed for a desk. Design the app they should actually be using.\n\nThis is the story of how that design came together — including the parts I got wrong on the first try.",
      },

      {
        ...
        navLabel: "Framing",
        navTime: "01",
        heading: "Before Any Screen Existed",
        body: "Two users, not one. The Sathi is the primary user — she operates the phone, and her job isn't \"fill a form,\" it's leave this shop with a complete, trustworthy application, however the next twenty minutes go. She's paid partly per completed application, so speed is a business metric here, not a UX nicety. Ramesh is the secondary user — he interrupts, walks away, and at one point takes the phone to check it himself. He's an active second user of the same screens, not a passive subject.",
      },
      {
        type: "noteBox",
        label: "A Signal I Almost Missed On The First Read",
        text: "The brief mentions, almost in passing, that Ramesh walks to the back of the shop twice during the visit. That single detail ended up shaping when document capture happens in the flow — documents are the thing most likely to be kept somewhere else in the shop, so the design leans into that instead of fighting it.",
      },
      {
        type: "textBlock",
        body: "Since there was no access to an actual Sathi to interview, the research here looked different from a typical discovery phase — closer reading than interviewing. I pulled patterns from comparable products instead: how field-KYC apps handle offline capture and case status, how fintech onboarding flows use document scanning to speed up form-filling, and how delivery and proof-of-work apps handle geotagged photo evidence. None of it was Vitto-specific, but it kept me from reinventing already-solved problems.",
      },
      {
        type: "defList",
        heading: "Constraints That Shaped Everything Downstream",
        items: [
          { label: "Device", value: "Budget Android, cracked screen protector, ~40% battery by afternoon, may run hot" },
          { label: "Environment", value: "Bright direct sunlight half the visits, signal drops entirely inside the market, loud and crowded" },
          { label: "Human", value: "4 interruptions in 20 min, doesn't know his GST number, guesses last month's purchases, reads English slowly" },
          { label: "Physical", value: "Her hands may be full — real one-handed operability, no precision gestures" },
          { label: "Process", value: "8–12 visits a day; a visit can end unfinished, or get cancelled outright" },
          { label: "Brand", value: "Red = primary action only, green = positive states, grey = neutral. WCAG 2.1 AA throughout" },
        ],
      },
      {
        type: "tagPills",
        heading: "Six Principles That Governed Every Later Decision",
        tags: ["Never Lose Work", "One Thing At A Time, One Thumb Away", "Evidence Now, Details Whenever", "Built To Be Taken Over", "Perceivable Under Duress", "Resilient To A Broken Plan"],
      },

      {
        type: "twoColText",
        index: "02 — Whiteboarding",
        navLabel: "Whiteboarding",
        navTime: "02",
        heading: "The Shape Of A Visit",
        body: "Before locking any order, I ran a genuine ideation pass rather than accepting the first clean answer — order, pause behavior, no-signal handling, and a wider sweep of edge cases. The most useful thing it surfaced wasn't a refinement, it was a gap: there was no screen for how a visit even starts. Every flow decision up to that point assumed Ramesh's identity already existed in the system. It doesn't, for a cold walk-in — which the brief itself describes as the normal case.\n\nThat became a small, deliberately minimal screen: shop name, owner's name, phone number, a \"walk-in\" tag, and one line — location tagged automatically when you save — so nothing about the visit's origin gets lost either.",
      },
      { type: "image", src: "images/vitto/VITTO-01-WHITEBOARD-ROUND-ONE.jpg", placeholder: "Whiteboard — first ideation round" },

      {
        type: "hmw",
        heading: "Translating The Reasoning Into User Stories",
        items: [
          "As a Sathi, I want to capture the shopfront photo the moment I arrive, so that the fraud-critical evidence isn't lost if the visit ends early.",
          "As a Sathi, I want every field to save the instant it's entered, so an interruption never costs me redone work.",
          "As a Sathi, I want to keep working with no signal, so a dead zone in the market doesn't stop my day.",
          "As a Sathi, I want to see exactly what's done and what's missing at a glance, so I don't have to remember it myself.",
          "As Ramesh, I want to see everything that's been entered about me before it's submitted, in a language I actually read comfortably.",
          "As Ramesh, I want to skip a question I genuinely can't answer, without the app treating that as an error.",
        ],
      },

      {
        type: "twoColText",
        index: "03 — Reversal",
        navLabel: "The Reversal",
        navTime: "03",
        heading: "The Decision I Reversed",
        body: "This is the part of the process worth reading closely if you only read one section — it's the clearest evidence of how I actually work, not just what I shipped.",
      },
      {
        type: "noteBox",
        label: "First Version",
        text: "Ramesh captures his own photo at the very end of the visit, while he's reviewing his data on the phone himself. It felt right on paper — it tied photo-taking to the trust-building moment of handing him the phone.",
      },
      {
        type: "challenges",
        heading: "Why It Broke, Once I Stress-Tested It Against Real Failure Modes",
        items: [
          { label: "Timing", q: "Where does it put the hardest-to-redo evidence?", a: "At the point in the visit most likely to never happen — a visit can end early, and the brief says so directly." },
          { label: "Trust", q: "What's the actual point of a live photo?", a: "That someone else confirms it, in the moment. A self-captured, unwitnessed photo undercuts the entire reason a live photo is required in the first place." },
          { label: "Confidence", q: "What's the worst moment to hand over unsupervised camera control?", a: "For the first time, right at the last step — the worst possible moment for someone not confident with the phone to fumble it." },
          { label: "Focus", q: "What does it stack onto one screen?", a: "Verify data, take a photo, read documents — three separate jobs, directly against my own \"one thing at a time\" principle." },
        ],
      },
      {
        type: "textBlock",
        body: "What I landed on instead: capture and review, split apart. Both photos are captured early, by the Sathi — the shopfront the moment she arrives, before any conversation; Ramesh's own photo right after one bundled consent ask, while he's still fully engaged. The end-of-visit, phone-in-his-hands moment became pure review: nothing new generated, only checked.\n\nThe reversal happened at the reasoning stage — a few minutes of stress-testing — instead of after a week of finished pixels. That's the actual point of doing it this way.",
      },
      { type: "imageGrid", cols: 2, images: [{ src: "images/vitto/VITTO-02-CAMERA-CAPTURE-LIVE.jpg", placeholder: "The camera capture screen, with alignment guide", aspect: "393/852", maxWidth: 300 }, { src: "images/vitto/VITTO-03-CAMERA-CAPTURE-FAILED.jpg", placeholder: "The failed-capture state", aspect: "393/852", maxWidth: 300 }] },

      {
        type: "twoColText",
        index: "04 — Screens",
        navLabel: "Building The Screens",
        navTime: "04",
        heading: "Building The Screens",
        body: "",
      },
      {
        type: "cardGrid",
        heading: "Key Decisions That Shaped The Final Set",
        cols: 2,
        items: [
          { title: "A Resumable Checklist, Not A Fixed Sequence", body: "The visit suggests a default order but never locks it, because a fixed sequence breaks the first time reality doesn't cooperate — which the brief's own scenario guarantees will happen." },
          { title: "Three Screens Became One", body: "Business details, financials, photo capture, and documents were originally separate; they got merged into a single scrollable flow with a progress bar and per-section status chips, so the checklist model is something she can actually see, not just something implied by a diagram." },
          { title: "Red Stays Reserved, Without Exception", body: "Even where it was tempting to use red for a \"something's missing\" flag, a small marker dot does that job instead, so red never competes with itself for meaning on one screen." },
          { title: "Skipped Is Different From Missing, Visually", body: "A skipped GST number reads as done-with-a-flag; a bank statement that was never captured reads as open. Treating those the same would have been a real accuracy loss." },
        ],
      },
      { type: "image", src: "images/vitto/VITTO-04-UNIFIED-VISIT-FLOW.jpg", placeholder: "The unified visit flow — business, financials, photos, documents in one scrollable screen", aspect: "393/852", maxWidth: 340 },
      { type: "imageGrid", cols: 2, images: [{ src: "images/vitto/VITTO-05-DAY-START.jpg", placeholder: "Day start — her entry point", aspect: "393/852", maxWidth: 300 }, { src: "images/vitto/VITTO-06-NEW-VISIT.jpg", placeholder: "New visit — the gap the whiteboard found", aspect: "393/852", maxWidth: 300 }] },

      {
        type: "textBlock",
        body: "Other decisions, smaller but deliberate: the submitted screen shows an application reference number, a short recap of what was submitted, and an honest incomplete-item status rather than a generic \"done\" message — and ends on a \"start next visit\" action, because the Sathi's day doesn't stop at one submission.\n\nRamesh's review screen shows the full borrower-facing field set, not a cherry-picked minimal version — an earlier draft showed only three fields to feel \"safer,\" but that made genuine cross-checking impossible. It also runs Hindi alongside every English label, since he reads English slowly.",
      },
      { type: "imageGrid", cols: 2, images: [{ src: "images/vitto/VITTO-07-RAMESH-REVIEW.jpg", placeholder: "Ramesh's review screen — bilingual, full field set", aspect: "393/852", maxWidth: 300 }, { src: "images/vitto/VITTO-08-SUBMITTED.jpg", placeholder: "Submitted, with an honest incomplete-item status", aspect: "393/852", maxWidth: 300 }] },

      {
        type: "twoColText",
        index: "05 — Round Two",
        navLabel: "The Four Hard Situations",
        navTime: "05",
        heading: "Whiteboarding, Round Two",
        body: "The brief names four situations as harder than the rest: an interrupted Sathi losing her place, eleven minutes with no signal, a field Ramesh genuinely can't answer, and Ramesh taking the phone himself. Rather than answer these once and move on, I ran a second ideation pass specifically on them — deeper than the brief strictly required.",
      },
      { type: "image", src: "images/vitto/VITTO-09-WHITEBOARD-ROUND-TWO.jpg", placeholder: "Whiteboard — deepening the four required awkward situations" },
      {
        type: "challenges",
        heading: "Four Hard Situations, Answered",
        items: [
          { label: "Interruption", q: "What happens when Ramesh gets pulled away?", a: "No extra recovery screen needed — every field saves the instant it's entered, and the progress bar and status chips are the \"you were here\" marker when she comes back." },
          { label: "No Signal", q: "What happens eleven minutes into a dead zone?", a: "Broadened, in review, into a general answer for device duress — battery, overheating, a crash — because the underlying response is identical for all of them: save locally, never block her." },
          { label: "Unknowable Field", q: "What if Ramesh genuinely doesn't know the answer?", a: "GST is explicitly skippable, worded to cover both \"not registered\" and \"don't know it offhand,\" and purchases is marked Estimated rather than presented as a number it isn't." },
          { label: "Ramesh Takes The Phone", q: "What does he actually have to check?", a: "The expanded, bilingual review screen — built specifically so there's something real for him to verify, not a token summary." },
        ],
      },
      { type: "imageGrid", cols: 2, images: [{ src: "images/vitto/VITTO-10-INTERRUPTION-RECOVERY.jpg", placeholder: "When Ramesh gets pulled away", aspect: "393/852", maxWidth: 300 }, { src: "images/vitto/VITTO-11-NO-SIGNAL-STATE.jpg", placeholder: "When signal drops mid-visit", aspect: "393/852", maxWidth: 300 }] },

      {
        type: "twoColText",
        index: "06 — Audit",
        navLabel: "Auditing, Instead Of Testing",
        navTime: "06",
        heading: "Auditing, Instead Of Testing",
        body: "I didn't have access to real Sathis to usability-test this with, so instead of user testing, I ran something I could actually do rigorously: a real WCAG 2.1 AA accessibility audit, computing contrast ratios rather than eyeballing them.",
      },
      {
        type: "defList",
        heading: "What It Found",
        items: [
          { label: "Primary text contrast", value: "17.7:1 — Pass" },
          { label: "Secondary text contrast", value: "7.6:1 — Pass, exceeds AAA" },
          { label: "Button text on red", value: "6.5:1 — Pass" },
          { label: "GST placeholder text", value: "2.7:1 — Failed, then fixed" },
          { label: "Back-arrow icons, text links", value: "Under 20×22px — Failed the 48dp minimum, fixed twice" },
          { label: "Color-only meaning anywhere", value: "None found — every status pairs color with text" },
        ],
      },
      {
        type: "textBlock",
        body: "Reviewing my own work a second time also surfaced real gaps I'd missed the first pass through: a screen for how a visit even starts (above), an actual example of the brief's own \"photograph that failed\" case — the PAN card capture now shows a genuine failure state with a retry action — and a geotag regression, where merging three screens into one accidentally dropped the location coordinates from the photo rows, leaving only the timestamp. Caught on review, restored before it shipped.",
      },

      {
        type: "twoColText",
        index: "07 — Closing",
        navLabel: "What I'd Do Next",
        navTime: "07",
        heading: "What I'd Do With Another Week",
        body: "A real icon set and camera art instead of text-only status and flat placeholders. Usability testing with an actual Sathi rather than assumptions. A proper receipt artifact to leave with Ramesh. A dedicated correction flow for when Ramesh flags something as wrong, rather than just handing control back to the Sathi. A decision on whether \"purchases\" should be a range input rather than a single exact figure, given it's an estimate by definition. And a real answer for what happens when a visit gets declined outright, rather than just paused — a case I identified and deliberately parked rather than half-build under the deadline.",
      },
      {
        type: "noteBox",
        label: "Assignment Outcome",
        text: "Submitted, with the interview process underway as of writing this. I'll update this note once I hear back — an honest incomplete-item status felt like the right way to end this one, too.",
      },
      { type: "bigStatement", text: "The reversal happened at the reasoning stage — a few minutes of stress-testing — instead of after a week of finished pixels. That's the actual point of doing it this way." },
      { type: "noteBox", label: "Say Hello", text: "Available for internships, freelance work, and conversations about design. There's a Mail Me button in the nav for exactly that — I read every message." },
    ],
  },
];
/* ---------------------------------------------------------------------- */
