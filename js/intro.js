  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function runIntro() {
      ...
      function settle() {
        ...
        // Read the active --intro-scale rather than assuming 1.32 — it's
        // responsive (see css/style.css), so this always matches whatever
        // scale actually rendered at the current viewport width.
        const introScale = parseFloat(getComputedStyle(introRow).getPropertyValue("--intro-scale")) || 1.32;
        const finalScale = introScale * scaleRatio;
